...
<head>
    ...
    <title>Tambah Data Post - Blog Rakel</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <style>
        body {
            background-color: lightblue; /* Warna latar belakang halaman */
        }
        .card {
            background-color: lightcyan; /* Warna latar belakang kartu */
            border-color: lightgrey; /* Warna border kartu */
        }
        .btn {
